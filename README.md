...
Send information about when Afterglow is next going to generate and
send control values to the lights, allowing patchers to set up
appropriate context, such as adjusting cue variables to be used in
creating the frame.
